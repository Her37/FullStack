    ...
    <div className="inicio">
        <div id="caja">
            <form id="form">
                ...
                <button className="acordion">buscar</button>
                <button className="acordion">lugar</button>
                <button className="acordion">tipo</button>
                <button className="acordion">alquiler</button>
            </form>
        </div>
